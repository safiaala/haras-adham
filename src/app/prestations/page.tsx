    ...
    <>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', minHeight:420 }}>
        <div style={{ padding:'50px 60px', display:'flex', flexDirection:'column', justifyContent:'center', background:'#fbf9f5' }}>
          <span style={{ fontSize:10, letterSpacing:'.26em', textTransform:'uppercase', color:'#B8943A', display:'block', marginBottom:7 }}>Acquisition & Courtage</span>
          <h2 style={{ fontFamily:'Noto Serif,serif', fontSize:'1.9rem', color:'#13201A', marginBottom:13 }}>Vente</h2>
          <p style={{ fontSize:12, color:'#6b6b6b', lineHeight:1.8, marginBottom:16 }}>Accompagnement dans la recherche et l'acquisition de votre futur partenaire. Du jeune cheval prometteur au crack de Grand Prix.</p>
        ...
        <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAptJR_8fTXy3rDmHr9AaLJUfZ3xI1pF_SzYVZtfT5ObmuUKnmpxe84_Wu-bJvTf5myeZMNQsN1Qk9sPZeKS-xLUF8LEs8rBA2U1Kb7J0vDDgmhRh2HtVPe0jeNTLAsdLSOeRegsXTBmeURydPPPuofn2HekhE9sxbKF3A-ASZLaRQspF5zhPlzXn1yr9jUjfUAdesFiaWGRoQEs-D10F-FqywLTf-7gI84AkjFnESUSctlSTxzP5U4jcFIjyrZolYXhwmVjnQ2JzDK" alt="Vente" style={{ width:'100%', objectFit:'cover', minHeight:300 }}/>
      </div>

      {/* PENSION */}
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', minHeight:420 }}>
        <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCqM16smGlXd1RU6bFo58nWrIrLwTLMmSD-PGpcrnnmDh41WZa2q81XruAlp_2jyoVx0whn-jmCKteq__S_6TkU0nAq6XlNHlGjMQdq8s9uTHcuvwNoqBLaOXo53Gy33hqYPQH-WToSNT8hcFlbHlZbvacZ7jNRT6ESS0XlZUEfeEuln20DDMncC99ghxsmllfTk9emUuCM6W3hO_dcT7gAzxPmZKy7JdYSNWsQGfzCeoSoWxRcewgNdB4lnbn12Bp-NuAyVmIctgKK" alt="Pension" style={{ width:'100%', objectFit:'cover', minHeight:300 }}/>
        <div style={{ padding:'50px 60px', display:'flex', flexDirection:'column', justifyContent:'center', background:'#f0ece4' }}>
          <span style={{ fontSize:10, letterSpacing:'.26em', textTransform:'uppercase', color:'#B8943A', display:'block', marginBottom:7 }}>Sérénité & Confort</span>
          <h2 style={{ fontFamily:'Noto Serif,serif', fontSize:'1.9rem', color:'#13201A', marginBottom:13 }}>Pension</h2>
          <p style={{ fontSize:12, color:'#6b6b6b', lineHeight:1.8, marginBottom:16 }}>30 boxes 4×4m, paille ou copeaux. Sorties paddock 4h/jour. Alimentation premium. Rapport photo hebdomadaire. Accès 7j/7.</p>
      ...
      <div style={{ padding:'55px 60px', background:'#fff' }}>
        <div style={{ maxWidth:1400, margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr', gap:32 }}>
          {[
            { img:'https://lh3.googleusercontent.com/aida-public/AB6AXuD2NVAICZ7oqJhye1KTR28lE5XJ2Eley-P5pI0bcQyDvI877-lWZ2d0RRqQ71Rmme68NEILxGX9W38K2wd7tz2iP7YZAvebprE9WK0rcyJFw0kOZacJxMlpNZ3qXmbTYHnR230iS7rNLmpcz_41gZIMKQG9Rp8GZAshT0wnZih_TjvP63dhiS2IMQ_ojdIjx7wE3Jl32tQRB2qBatXIo6x8QRyBPAm847ssE_rPalJyUHMl7eJFnGRTAJ40vVHCgtTEeXAeuU9NZ9kB', badge:'Pédagogie & Harmonie', titre:'Enseignement', desc:'Cours individuels et petits groupes (max 4). Stages perfectionnement. Tous niveaux, méthodes douces. Préparation Galop 1–7.', cta:'Réserver un cours' },
            { img:'https://lh3.googleusercontent.com/aida-public/AB6AXuDx-knZ_C0_Sy5CkOt5oWY9xDKqPmewCDS2d5SZ_Dk8GsLFM31Ms88oezeZQLV2S94r3gfIq4BLd-O1YB9B4vbj5CJbqI9j6_R0cTFpe_hopMaiw9Ff5HxTjehSpwIoA4_GzEMdn-KML2uh3_iBwDU23TiNl-shbWWTQ90Ssv-BLR9nMwzuB3Qyyzn8nC69zYtpe_ys1F7E0bnr2YnRjZEkZUl2VSFEBiNOHJy4-AUHCczmCm-1IvG9u0AA6zkkp4Xuo7aYUJfgJJaZ', badge:'Performance & Rigueur', titre:'Compétition', desc:'Préparation sportive, suivi vétérinaire sportif. Circuits CSI, CDI nationaux et internationaux. Camion transport 6 chevaux.', cta:'Nous rejoindre' },
          ].map(s => (
            <div key={s.titre} style={{ border:'.5px solid rgba(195,200,195,.35)', padding:28 }}>
              <img src={s.img} alt={s.titre} style={{ width:'100%', height:180, objectFit:'cover', marginBottom:16 }}/>
              <span style={{ fontSize:'9.5px', letterSpacing:'.22em', textTransform:'uppercase', color:'#B8943A', display:'block', marginBottom:6 }}>{s.badge}</span>
              <h3 style={{ fontFamily:'Noto Serif,serif', fontSize:'1.5rem', color:'#13201A', marginBottom:10 }}>{s.titre}</h3>
              <p style={{ fontSize:11, color:'#6b6b6b', lineHeight:1.7, marginBottom:13 }}>{s.desc}</p>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', minHeight:380 }}>
        <div style={{ padding:'50px 60px', display:'flex', flexDirection:'column', justifyContent:'center', background:'#fbf9f5' }}>
          <span style={{ fontSize:10, letterSpacing:'.26em', textTransform:'uppercase', color:'#B8943A', display:'block', marginBottom:7 }}>Génétique & Futur</span>
          <h2 style={{ fontFamily:'Noto Serif,serif', fontSize:'1.9rem', color:'#13201A', marginBottom:13 }}>Reproduction</h2>
          <p style={{ fontSize:12, color:'#6b6b6b', lineHeight:1.8, marginBottom:14 }}>IAF, IAC et monte naturelle. Suivi gynécologique par échographie. Poulinage sous surveillance 24h/24. Transfert d'embryons disponible.</p>
        ...
        <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuCPJrHgNeV-Hy5TkRKGfcDUsh0hFitwygsNUY4Qq2JNwCuH6oIsNsT-1JlaEtenGdDoUoMGYCoimueBOBJ1Hj-Imqw6lt5_8f9lZ9NS4QHPjG_Pg5znuSJAPfMHeJOh0yNGz0zGV2wxsbWtbypmw_LBzJinIZTVzmZ5K9uwsVbDH9SW0mponXjwbFwLKNCZJOIRDcZ1MVaepPYWjYbRgXrvgn8CKR_3VUDKz7oHwcbc36bIH_6di7PA4YkNbE-T9iJ8-vyYCX6cd_Ft" alt="Reproduction" style={{ width:'100%', objectFit:'cover', minHeight:280 }}/>
      </div>
